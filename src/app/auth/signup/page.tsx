    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-[#0a0a0f]">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold">Start your quest</h1>
          <p className="text-slate-400 text-sm mt-1">Create your player account</p>
        </div>
        <form onSubmit={handleSubmit} className="p-6 rounded-2xl bg-[#12121a] border border-white/5 space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 font-medium transition disabled:opacity-50"
          >
